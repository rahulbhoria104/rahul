	...
	public function get() {
		return apply_filters(
			...
			[
				...
				[
					'id'        => 'knowsAbout',
					'label'     => __( 'Knows about', 'surerank' ),
					'default'   => false,
					'show'      => true,
					'tooltip'   => __( 'Add topics the person has expertise in, one topic per entry. This helps search engines and AI systems understand the person\'s areas of knowledge.', 'surerank' ),
					'cloneable' => true,
					'flatten'   => true,
					'std'       => '',
				],
				[
					'id'               => 'hasCredential',
					'label'            => __( 'Credentials', 'surerank' ),
					'default'          => false,
					'show'             => true,
					'tooltip'          => __( 'Add degrees, certifications, or licenses held by the person.', 'surerank' ),
					'type'             => 'Group',
					'cloneable'        => true,
					'cloneItemHeading' => __( 'Credential', 'surerank' ),
					'fields'           => [
						[
							'id'       => '@type',
						...
						[
							'id'       => 'name',
							'label'    => __( 'Credential name', 'surerank' ),
							'tooltip'  => __( 'The name of the credential, for example "MSc in Nutrition".', 'surerank' ),
							'type'     => 'Text',
							'show'     => true,
							'required' => true,
						],
						[
							...
							'label'   => __( 'Credential category', 'surerank' ),
							'tooltip' => __( 'The category of the credential, such as degree, certification, or license.', 'surerank' ),
							'type'    => 'Text',
							'show'    => true,
						],
						[
							'id'      => 'recognizedBy',
							'label'   => __( 'Recognized by', 'surerank' ),
							'tooltip' => __( 'The organization that awarded or recognizes this credential.', 'surerank' ),
							'type'    => 'Group',
							'show'    => true,
							'fields'  => [
								[
									...
									'options'  => [
										...
										'EducationalOrganization' => __( 'Educational organization', 'surerank' ),
									],
								],
								[
									'id'    => 'name',
				...
				[
					'id'               => 'alumniOf',
					'label'            => __( 'Alumni of', 'surerank' ),
					'default'          => false,
					'show'             => true,
					'tooltip'          => __( 'Add schools, colleges, or organizations the person has studied at or been part of.', 'surerank' ),
					'type'             => 'Group',
					'cloneable'        => true,
					'cloneItemHeading' => __( 'Organization', 'surerank' ),
					'fields'           => [
						[
							'id'       => '@type',
							'label'    => __( 'Organization type', 'surerank' ),
							...
							'options'  => [
								'EducationalOrganization' => __( 'Educational organization', 'surerank' ),
								'CollegeOrUniversity'     => __( 'College or university', 'surerank' ),
								'Organization'            => __( 'Organization', 'surerank' ),
							],
						],
						[
						...
						[
							'id'      => 'url',
							'label'   => __( 'URL', 'surerank' ),
							'tooltip' => __( 'The website of the organization.', 'surerank' ),
							'type'    => 'Text',
							'show'    => true,
						],
						[
							'id'      => 'sameAs',
							'label'   => __( 'Same as', 'surerank' ),
							'tooltip' => __( 'A reference link that identifies the organization, such as a Wikipedia page or Wikidata entry.', 'surerank' ),
							'type'    => 'Text',
							'show'    => true,
						],
					],
