(function(_wordpress_i18n, react, react_dom, _elementor_ui, _elementor_query, _elementor_icons, _elementor_editor_app_bar, _elementor_icons_SpeakerphoneIcon) {
...
_elementor_icons_SpeakerphoneIcon = __toESM(_elementor_icons_SpeakerphoneIcon);
...
//#endregion
//#region modules/notifications/assets/js/components/editor-drawer.js
	var EditorDrawer = function EditorDrawer(_ref) {
		var _ref$anchorPosition = _ref.anchorPosition;
		var anchorPosition = _ref$anchorPosition === void 0 ? "left" : _ref$anchorPosition;
		...
		return /*#__PURE__*/ react.default.createElement(WhatsNew, {
			isOpen,
			setIsOpen,
	...
	EditorDrawer.propTypes = { anchorPosition: import_prop_types.default.oneOf([
		"left",
		"top",
		"right",
		"bottom"
...
//#endregion
//#region modules/notifications/assets/js/components/editor-on-button-clicked.js
	var isRendered = false;
	var editorOnButtonClicked = function editorOnButtonClicked() {
		var anchorPosition = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : "left";
		if (!isRendered) {
			isRendered = true;
			var container = document.createElement("div");
			document.body.append(container);
			react_default.render(/*#__PURE__*/ react.default.createElement(EditorDrawer, { anchorPosition }), container);
			return;
		}
...
//#endregion
//#region modules/notifications/assets/js/components/editor-v1.js
	var editorV1 = function editorV1() {
		elementor.on("panel:init", function() {
			if (elementorNotifications.is_unread) document.body.classList.add("e-has-notification");
			elementor.getPanelView().getPages("menu").view.addItem({
				name: "notification-center",
				icon: "eicon-speakerphone",
				title: (0, _wordpress_i18n.__)("What's New", "elementor"),
...
//#endregion
//#region modules/notifications/assets/js/components/editor-app-bar-link.js
	var IconWithBadge = function IconWithBadge(_ref) {
		...
		return /*#__PURE__*/ react.default.createElement(_elementor_ui.Badge, {
			...
			badgeContent: count,
			invisible: 0 === count
		}, /*#__PURE__*/ react.default.createElement(_elementor_icons_SpeakerphoneIcon.default, null));
	};
	IconWithBadge.propTypes = { count: import_prop_types.default.number };
	var useWhatsNewLinkProps = function useWhatsNewLinkProps() {
		var _window$elementorNoti;
		var _useState2 = _slicedToArray((0, react.useState)(parseInt((_window$elementorNoti = window.elementorNotifications) === null || _window$elementorNoti === void 0 ? void 0 : _window$elementorNoti.unread_count, 10) || 0), 2);
		var unreadCount = _useState2[0];
		var setUnreadCount = _useState2[1];
		(0, react.useEffect)(function() {
		...
		return {
			title: (0, _wordpress_i18n.__)("What's New", "elementor"),
			icon: function icon() {
				return /*#__PURE__*/ react.default.createElement(IconWithBadge, { count: unreadCount });
			},
			onClick: function onClick() {
...
//#endregion
//#region modules/notifications/assets/js/editor.js
	var _window;
	if ((_window = window) !== null && _window !== void 0 && (_window = _window.elementorV2) !== null && _window !== void 0 && _window.editorAppBar) editorAppBarLink();
	else editorV1();

//#endregion
})(wp.i18n, React, ReactDOM, elementorV2.ui, elementorV2.query, elementorV2.icons, elementorV2.editorAppBar, elementorV2.icons['SpeakerphoneIcon']);
