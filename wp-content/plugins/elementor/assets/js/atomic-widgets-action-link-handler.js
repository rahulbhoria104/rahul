...
//#endregion
//#region modules/atomic-widgets/assets/js/frontend/action-link-handlers.js
	...
	function shouldFireLinkActionHandler(url) {
		var _actionMatch$;
		var _elementorFrontend$ho;
		var _elementorFrontend;
		if (!(0, _utils.isEditorContext)()) return true;
		url = decodeURI(url);
		url = decodeURIComponent(url);
		const actionMatch = url.match(/action=([^&]+)/);
		const action = (_actionMatch$ = actionMatch === null || actionMatch === void 0 ? void 0 : actionMatch[1]) !== null && _actionMatch$ !== void 0 ? _actionMatch$ : null;
		if (!action) return false;
		return !!((_elementorFrontend$ho = (_elementorFrontend = elementorFrontend) === null || _elementorFrontend === void 0 || (_elementorFrontend = _elementorFrontend.hooks) === null || _elementorFrontend === void 0 ? void 0 : _elementorFrontend.applyFilters(_utils.WHITELIST_FILTER, _utils.LINK_ACTIONS_EDITOR_WHITELIST)) !== null && _elementorFrontend$ho !== void 0 ? _elementorFrontend$ho : _utils.LINK_ACTIONS_EDITOR_WHITELIST).find((allowedAction) => action.includes(allowedAction));
	}
	function handleLinkActions(element) {
		...
		const url = actionLinkElement === null || actionLinkElement === void 0 ? void 0 : actionLinkElement.dataset.actionLink;
		if (!url) return;
		const handler = (event) => {
			var _window$elementorFron;
			if (actionLinkElement && actionLinkElement !== element && !actionLinkElement.contains(event.target)) return;
			if (!shouldFireLinkActionHandler(url)) return;
			if (!((_window$elementorFron = window.elementorFrontend) === null || _window$elementorFron === void 0 || (_window$elementorFron = _window$elementorFron.utils) === null || _window$elementorFron === void 0 ? void 0 : _window$elementorFron.urlActions)) return;
