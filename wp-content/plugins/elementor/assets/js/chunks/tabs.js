...
//#endregion
//#region assets/dev/js/frontend/handlers/base-tabs.js
	var require_base_tabs = /* @__PURE__ */ __commonJSMin(((exports) => {
		...
		var baseTabs = class extends elementorModules.frontend.handlers.Base {
			getDefaultSettings() {
				return {
					selectors: {
			...
			onEditSettingsChange(propertyName) {
				if ("activeItemIndex" === propertyName) this.activateDefaultTab();
			}
...
//#endregion
//#region assets/dev/js/frontend/handlers/tabs.js
	var require_tabs = /* @__PURE__ */ __commonJSMin(((exports) => {
		init_objectSpread2();
		var _interopRequireDefault = require_interopRequireDefault();
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		var _baseTabs = _interopRequireDefault(require_base_tabs());
		var Tabs = class extends _baseTabs.default {
			getDefaultSettings() {
				return _objectSpread2(_objectSpread2({}, super.getDefaultSettings()), {}, { toggleSelf: false });
			}
		};
...
//#region \0elementor-chunk-entry
	var import_tabs = /* @__PURE__ */ __toESM(require_tabs());
	(window.__elementorChunks = window.__elementorChunks || {})["tabs"] = import_tabs;
