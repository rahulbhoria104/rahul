...
//#endregion
//#region assets/dev/js/frontend/handlers/background-slideshow.js
	var require_background_slideshow = /* @__PURE__ */ __commonJSMin(((exports) => {
		init_asyncToGenerator();
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		require_esnext_iterator_constructor();
		require_esnext_iterator_for_each();
		var BackgroundSlideshow = class extends elementorModules.frontend.handlers.SwiperBase {
			getDefaultSettings() {
				return { classes: {
			...
			getSwiperOptions() {
				...
				const swiperOptions = {
					...
					on: { slideChange: () => {
						if (elementSettings.background_slideshow_ken_burns) this.handleKenBurns();
					} }
				};
				if ("yes" === elementSettings.background_slideshow_loop) swiperOptions.loopedSlides = this.getSlidesCount();
				...
				if ("yes" === elementSettings.background_slideshow_lazyload) swiperOptions.lazy = {
					loadPrevNext: true,
			...
			buildSwiperElements() {
				...
				const elementSettings = this.getElementSettings();
				const direction = "slide_left" === elementSettings.background_slideshow_slide_transition ? "ltr" : "rtl";
				const $container = jQuery("<div>", {
					class: classes.swiperContainer,
					dir: direction
				});
				const $wrapper = jQuery("<div>", { class: classes.swiperWrapper });
				const kenBurnsActive = elementSettings.background_slideshow_ken_burns;
				const lazyload = "yes" === elementSettings.background_slideshow_lazyload;
			...
			initSlider() {
				...
				return _asyncToGenerator(function* () {
					...
					_this.swiper = yield new Swiper(_this.elements.$backgroundSlideShowContainer, _this.getSwiperOptions());
					_this.elements.$backgroundSlideShowContainer.data("swiper", _this.swiper);
					if (elementSettings.background_slideshow_ken_burns) _this.handleKenBurns();
				})();
			}
			activate() {
			...
			run() {
				if ("slideshow" === this.getElementSettings("background_background")) this.activate();
				else this.deactivate();
			}
			onInit() {
				super.onInit();
				if (this.getElementSettings("background_slideshow_gallery")) this.run();
			}
			onDestroy() {
				super.onDestroy();
				this.deactivate();
...
//#region \0elementor-chunk-entry
	var import_background_slideshow = /* @__PURE__ */ __toESM(require_background_slideshow());
	(window.__elementorChunks = window.__elementorChunks || {})["background-slideshow"] = import_background_slideshow;

//#endregion
})();
//# sourceMappingURL=background-slideshow.js.map