...
//#endregion
//#region assets/dev/js/frontend/handlers/container/shapes.js
	var require_shapes = /* @__PURE__ */ __commonJSMin(((exports) => {
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		require_esnext_iterator_constructor();
		require_esnext_iterator_find();
		var Shapes = class extends elementorModules.frontend.handlers.Base {
			getDefaultSettings() {
				return {
					selectors: { container: "boxed" === this.getElementSettings("content_width") ? "> .e-con-inner > .elementor-shape-%s" : "> .elementor-shape-%s" },
			...
			getSvgURL(shapeType, fileName) {
				...
				if (elementor.config.additional_shapes && shapeType in elementor.config.additional_shapes) {
					...
					if (-1 < fileName.indexOf("-negative")) svgURL = svgURL.replace(".svg", "-negative.svg");
				}
				return svgURL;
			}
			buildSVG(side) {
				const baseSettingKey = "shape_divider_" + side;
				const shapeType = this.getElementSettings(baseSettingKey);
				const $svgContainer = this.elements["$" + side + "Container"];
				...
				if (this.getElementSettings(baseSettingKey + "_negative")) fileName += "-negative";
			...
			onInit(...args) {
				...
				["top", "bottom"].forEach((side) => {
					if (this.getElementSettings("shape_divider_" + side)) this.buildSVG(side);
				});
			}
...
//#region \0elementor-chunk-entry
	var import_shapes = /* @__PURE__ */ __toESM(require_shapes());
	(window.__elementorChunks = window.__elementorChunks || {})["container-shapes"] = import_shapes;

//#endregion
})();
//# sourceMappingURL=container-shapes.js.map