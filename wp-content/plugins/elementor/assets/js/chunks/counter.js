...
//#endregion
//#region assets/dev/js/frontend/handlers/counter.js
	var require_counter = /* @__PURE__ */ __commonJSMin(((exports) => {
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		require_esnext_iterator_constructor();
		require_esnext_iterator_find();
		var Counter = class extends elementorModules.frontend.handlers.Base {
			getDefaultSettings() {
				return { selectors: { counterNumber: ".elementor-counter-number" } };
			}
			getDefaultElements() {
				const selectors = this.getSettings("selectors");
				return { $counterNumber: this.$element.find(selectors.counterNumber) };
			}
			onInit() {
				super.onInit();
...
//#region \0elementor-chunk-entry
	var import_counter = /* @__PURE__ */ __toESM(require_counter());
	(window.__elementorChunks = window.__elementorChunks || {})["counter"] = import_counter;
