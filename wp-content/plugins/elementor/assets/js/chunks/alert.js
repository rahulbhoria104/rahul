...
//#endregion
//#region assets/dev/js/frontend/handlers/alert.js
	var require_alert = /* @__PURE__ */ __commonJSMin(((exports) => {
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		require_esnext_iterator_constructor();
		require_esnext_iterator_find();
		var Alert = class extends elementorModules.frontend.handlers.Base {
			getDefaultSettings() {
				return { selectors: { dismissButton: ".elementor-alert-dismiss" } };
			}
			getDefaultElements() {
				const selectors = this.getSettings("selectors");
				return { $dismissButton: this.$element.find(selectors.dismissButton) };
			}
			bindEvents() {
...
//#region \0elementor-chunk-entry
	var import_alert = /* @__PURE__ */ __toESM(require_alert());
	(window.__elementorChunks = window.__elementorChunks || {})["alert"] = import_alert;
