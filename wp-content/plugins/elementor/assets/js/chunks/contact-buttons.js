...
//#endregion
//#region modules/floating-buttons/assets/js/floating-buttons/frontend/handlers/contact-buttons.js
	var require_contact_buttons = /* @__PURE__ */ __commonJSMin(((exports) => {
		var _interopRequireDefault = require_interopRequireDefault();
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		var _base = _interopRequireDefault(require_base());
		var _clickTracking = _interopRequireDefault(require_click_tracking());
		var ContactButtonsHandler = class extends _base.default {
			getDefaultSettings() {
				return {
					selectors: {
...
//#region \0elementor-chunk-entry
	var import_contact_buttons = /* @__PURE__ */ __toESM(require_contact_buttons());
	(window.__elementorChunks = window.__elementorChunks || {})["contact-buttons"] = import_contact_buttons;
