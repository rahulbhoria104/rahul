...
//#endregion
//#region modules/floating-buttons/assets/js/floating-bars/frontend/classes/floatin-bar-dom.js
	var require_floatin_bar_dom = /* @__PURE__ */ __commonJSMin(((exports) => {
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		var FloatingBarDomHelper = class {
			constructor($element) {
...
//#region modules/floating-buttons/assets/js/shared/frontend/handlers/click-tracking.js
	var require_click_tracking = /* @__PURE__ */ __commonJSMin(((exports) => {
		init_defineProperty();
		...
		var ClickTrackingHandler = class extends _base.default {
			constructor(..._args) {
				super(..._args);
			...
			onChatButtonTrackClick(event) {
				...
				const selectors = this.getSettings("selectors");
				if (targetElement.matches(selectors.contactButtonCore) || targetElement.closest(selectors.contactButtonCore) || targetElement.matches(selectors.floatingBarCTAButton) || targetElement.closest(selectors.floatingBarCTAButton)) this.getDocumentIdAndTrack(targetElement, selectors);
			}
...
//#endregion
//#region modules/floating-buttons/assets/js/floating-bars/frontend/handlers/floating-bars.js
	var require_floating_bars = /* @__PURE__ */ __commonJSMin(((exports) => {
		var _interopRequireDefault = require_interopRequireDefault();
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.default = void 0;
		...
		require_esnext_iterator_for_each();
		var _base = _interopRequireDefault(require_base());
		var _floatinBarDom = _interopRequireDefault(require_floatin_bar_dom());
		var _clickTracking = _interopRequireDefault(require_click_tracking());
		var FloatingBarsHandler = class extends _base.default {
			getDefaultSettings() {
				return {
					selectors: {
			...
			onElementChange(property) {
				if (["advanced_vertical_position"].includes(property)) this.initDefaultState();
			}
			...
			initEntranceAnimation() {
				...
				const setTimeoutDelay = (this.getResponsiveSetting(ctaEntranceAnimationDelay) || 0) + 500;
			...
			onInit(...args) {
				const { hasEntranceAnimation } = this.getSettings("constants");
				super.onInit(...args);
				this.clickTrackingHandler = new _clickTracking.default({ $element: this.$element });
				new _floatinBarDom.default(this.$element).maybeMoveToTop();
				if (this.elements.ctaButton && this.elements.ctaButton.classList.contains(hasEntranceAnimation)) this.initEntranceAnimation();
...
//#region \0elementor-chunk-entry
	var import_floating_bars = /* @__PURE__ */ __toESM(require_floating_bars());
	(window.__elementorChunks = window.__elementorChunks || {})["floating-bars"] = import_floating_bars;

//#endregion
})();
//# sourceMappingURL=floating-bars.js.map