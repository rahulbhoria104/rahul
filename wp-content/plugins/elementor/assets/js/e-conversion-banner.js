...
//#endregion
//#region modules/promotions/assets/js/conversion-banner/conversion-banner.js
	...
	var relocateBanner = function relocateBanner(container, placement) {
		...
		var _placement$before = placement.before;
		var before = _placement$before === void 0 ? false : _placement$before;
	...
	var bindDismiss = function bindDismiss(container) {
		...
		dismissButton.addEventListener("click", /*#__PURE__*/ _asyncToGenerator(/*#__PURE__*/ import_regenerator.default.mark(function _callee() {
			return import_regenerator.default.wrap(function(_context) {
				while (1) switch (_context.prev = _context.next) {
					case 0:
						_context.prev = 0;
						_context.next = 1;
						return wp.ajax.post(eConversionBanner.action, { nonce: eConversionBanner.nonce });
					case 1:
						_context.next = 3;
						break;
					case 2:
	...
	var init = function init() {
		...
		if (!container || "undefined" === typeof eConversionBanner) return;
